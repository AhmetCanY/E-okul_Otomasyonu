...
namespace Ödev
{
    public partial class Form7 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < listView1.Items.Count; i++)
            {
                if (listView1.Items[i].SubItems[0].Text == textBox1.Text)
                {
                    ...
                    textBox2.Enabled = false; textBox3.Enabled = false; textBox5.Enabled = true;
                    textBox4.Enabled = false; textBox6.Enabled = false; textBox7.Enabled = false;
                }
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand komut = new OleDbCommand();
            komut.Connection = baglantı;
            komut.CommandText = "update Öğrenci set Matematik_Not='" + textBox5.Text + "'where Öğrenci_No='" + textBox1.Text + "'"; komut.ExecuteNonQuery();
            baglantı.Close();
